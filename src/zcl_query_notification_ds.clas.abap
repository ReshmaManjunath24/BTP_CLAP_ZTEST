CLASS zcl_query_notification_ds DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_query_notification_ds IMPLEMENTATION.
...
*        lo_mail->add_recipient( 'reshma.m@vaspp.com' ).
        ...
        iv_message = '<p>Dear CC,</p> <p>the The Approver A has added a Query to the following request :</p><p> Reqeust_No: Request1 </p><p> customer: customer1 </p><p> comment: comment1</p> <p>Open Clap Request</p> '.
        ...
        REPLACE 'CC' WITH ls_customer-datasteward_name INTO
       iv_message.
